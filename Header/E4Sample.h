...
struct E4Sample final
{
	...
	[[nodiscard]] uint32_t GetSampleRate() const { return m_sample_rate; }
...
private:
	[[maybe_unused]] uint16_t m_padding = 0ui16;
	...
	[[maybe_unused]] std::array<uint32_t, E4BVariables::NUM_EXTRA_SAMPLE_PARAMETERS> m_extraParams{}; // always seems to be empty
};
