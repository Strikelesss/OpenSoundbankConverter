...
private:
  ...
  std::unique_ptr<RIFFChunkInterface> MakeInfoListChunk() const;

  /// Make a sdta chunk.
  /// @return the sdta chunk.
  std::unique_ptr<RIFFChunkInterface> MakeSdtaListChunk() const;

  /// Make a pdta chunk.
  /// @return the pdta chunk.
  std::unique_ptr<RIFFChunkInterface> MakePdtaListChunk() const;
